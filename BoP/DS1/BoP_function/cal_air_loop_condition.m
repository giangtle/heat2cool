function [air_1, air_3, air_4, air_5, H2O_consumption] = cal_air_loop_condition(T_env, T_cold_aisle, T_hot_aisle, yH2O_ads)
% Temperature air_3 stream is limitted by environment temperature.
air_3 = struct(); air_3.phase = "gas"; air_3.T = T_env+5;
air_3.yH2O = yH2O_ads;
air_3.yO2 = 0.21*(1-yH2O_ads);
air_3.yN2 = 0.79*(1-yH2O_ads);
air_3.n = 1;
% Calculate air_4 streams and water consumption:
...
if air_4.yH2O > cal_water_y_sat(air_4.T)
